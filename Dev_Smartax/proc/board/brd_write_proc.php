<?php
	...
	try
	{
		...
		if ($res)
		{
			if($puid > 0) header("Location:../../view/board/board_list.php?tbl_kind=" . $_POST['tbl_kind'] . "&pg_inx=".$_POST['pg_inx']);
			else header("Location:../../view/board/board_list.php?tbl_kind=" . $_POST['tbl_kind'] . "&pg_inx=1");
		}
		else
		{
