...
$worksheet =& $workbook->addWorksheet('매입 부가세 자료입력');

$worksheet->setInputEncoding('utf-8');
$worksheet->write(0, 0, "매입자료입력", $format_title);
...
$worksheet->write(1, 0, "Ⅰ. 공급받는자 인적사항", $format_sub_title);
...
$worksheet->write(5, 0, "Ⅱ. 매입 부가세 거래내역", $format_sub_title);
...
$worksheet->write(7, 11, "의제, 재활용\n적요번호\n(차 변)",$format_table_gray);
$worksheet->write(7, 12, "상대계정\n(대 변)",$format_table_gray);
$worksheet->write(7, 13, "영수/청구",$format_table_gray);
$worksheet->write(7, 14, "대표자\n(15자리)",$format_table_gray);
$worksheet->write(7, 15, "업 태\n(20자리)",$format_table_gray);
$worksheet->write(7, 16, "종 목\n(30자리)",$format_table_gray);
$worksheet->write(7, 17, "사업장주소\n(80자리)",$format_table_gray);
$worksheet->write(7, 18, "비고\n(30자리)",$format_table_gray);
$worksheet->write(7, 19, "전자",$format_table_gray);
$worksheet->write(7, 20, "부서/사원\n코드",$format_table_gray);
$worksheet->write(7, 21, "현장코드",$format_table_gray);
$worksheet->write(7, 22, "PJT코드",$format_table_gray);
$worksheet->write(7, 23, "불공제사유",$format_table_gray);
...
$worksheet->write(8, 23, "",$format_table_gray);
...
for($i=0;$i < count($res);$i++){
	...
	$worksheet->write(9+$i, 23, "",$format_table_content);
}
