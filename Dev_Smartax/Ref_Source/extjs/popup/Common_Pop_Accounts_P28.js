...
Ext.define('Common_Pop_Accounts_P28', {
    ...
    onGridpanelItemDblClick: function(dataview, record, item, index, e, eOpts) {
    	...
    	{
    		var gycodeModiText = ValidateFunc.gycodeValidByGubun2(this.record, record.get('gycode'));
    ...
    onSelectClick: function() {
    	...
    	{
    		var gycodeModiText = ValidateFunc.gycodeValidByGubun2(this.record, selectData.gycode);
    		if(gycodeModiText != '') Ext.Msg.alert("", gycodeModiText);
    		else
    		{
