...
//***************************************  컨트롤러 ***************************************//
    ...
    onContainerAfterRender: function(component, eOpts) {
		...
		var now = new Date();
    	Ext.getCmp('menu02_date_str').setValue( new Date('1/1/'+now.getFullYear()));
		Ext.getCmp('menu02_date_end').setValue(new Date());
    ...
    onMenu02_SearchBtnClick: function(button, e, eOpts) {
    	...
    	var searchDate = Ext.getCmp('menu02_date_end').getValue();
    	...
    	Ext.getCmp('menu02_date_str').setValue( new Date('1/1/'+year));
