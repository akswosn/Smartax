									...
									items: [
										{
						               		...
						               		cls:'bottomChild',
						               		handler : function(){
						               			Ext.ux.grid.Printer.mainTitle = '[ 작업코드 ]';
...
//***************************************  컨트롤러 ***************************************//
    ...
    onContainerAfterRender: function(component, eOpts) {
    	...
    	Ext.getCmp('workcd_reg').add(this.form);
    ...
    onRegisterCode: function(button, e, eOpts){
		...
		if(!thisObj.form.txtField.readOnly)
		{
    		...
    		{
    			Ext.MessageBox.confirm('경고!', '이미추가된 작업명입니다. 추가로 저장 하시겠습니까?', function(btn){
		            if(btn=='yes'){
