...
//***************************************  컨트롤러 ***************************************//
    ...
    onContainerAfterRender: function(component, eOpts) {
    	...
    	this.totDeb = 0; 
		this.totCre = 0;
		Ext.getCmp('menu29_date').setValue(new Date());
    ...
    onTreepanelLoad: function(treestore, node, records, successful, eOpts) {
    	...
    	if(node.childNodes.length > 0)
    	{
    		this.totDeb = 0;
    		this.totCre = 0;
    		this.amSum(Ext.getCmp('Menu29_Grid').getRootNode());
			Ext.getCmp('Menu29_Grid').getRootNode().appendChild({
	    		gycode:'입출합계',
	    		type: -1,
		        gicho_am: '',
			...
			Ext.getCmp('Menu29_Grid').expandAll();	
    	}
    },
    ...
    onMenu29_SearchBtnClick: function(button, e, eOpts) {
    	...
    	if(year && month && day)
    	{
    		...
    		StoreInfo.Menu29_Grid.setProxy({
    			type: 'ajax',
