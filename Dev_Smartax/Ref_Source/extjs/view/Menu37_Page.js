 ...
 * @page 계산서합계표
 * @author 이교철
 * @history 2014.03.30 작성
 */
var thisObj = null;

Ext.define('Menu37_Page', { //클래스 정의
		                ...
		                { //조회조건 (1.정기신고, 2.수정신고)
		                    ...
		                    listeners: {
		                        ...
		                        change: function(field, newValue, oldValue, eOpts) {
		                            ...
		                            Ext.getCmp('Menu37_Type_Text').setText(text);
		                        }
		                    }
		                },
							                    ...
							                    handler: function() {
							                    	if(thisObj.temp.type == 0)
							                    	{
							                    		...
							                    		thisObj.onRequestBasicInfo(function(){
								                    		...
								                    		window.open("./extjs/print/add_tax/print_out_add_sales_sum.html", "", "width=955, height=1000, toolbar=no, menubar=no, scrollbars=yes, location=no" );
								                    	});
							                    	}
							                    	else
						                    		{
							                    		...
							                    		thisObj.onRequestBasicInfo(function(){
								                    		...
								                    		console.log(Global.temp);
								                    		window.open("./extjs/print/add_tax/print_out_add_purchase_sum.html", "", "width=955, height=1000, toolbar=no, menubar=no, scrollbars=yes, location=no" );
								                    	});
						                    		}
							                    }
							                },
    ...
    onContainerAfterRender: function(component, eOpts) {
        ...
        //현재 날짜 기준으로 조회년월 셋팅
        var now = new Date();
        Ext.getCmp('Menu37_From_Year').setValue(now.getFullYear());
        //Ext.getCmp('Menu37_From_Month').setValue(1);
        //Ext.getCmp('Menu37_To_Year').setValue(now.getFullYear());
        //Ext.getCmp('Menu37_To_Month').setValue(1);
        
        //조회조건 초기 셋팅
        thisObj.param = new Object();
        thisObj.param.from_atax_yyyymm = now.getFullYear() + Ext.String.leftPad(1, 2, '0');
        thisObj.param.to_atax_yyyymm = now.getFullYear() + Ext.String.leftPad(1, 2, '0');
        thisObj.param.type1 = '12';
        ...
        this.store[0] = { //매출
            total : StoreInfo.Menu37_Grid1,
            sumY : StoreInfo.Menu37_Grid2,
            sumN : StoreInfo.Menu37_Grid3,
            dataY : StoreInfo.Menu37_Grid4,
            dataN : StoreInfo.Menu37_Grid5,
            dataAll : StoreInfo.Menu37_Grid6
        };
        this.store[1] = { //매입
            total : StoreInfo.Menu37_Grid7,
            sumY : StoreInfo.Menu37_Grid8,
            sumN : StoreInfo.Menu37_Grid9,
            dataY : StoreInfo.Menu37_Grid10,
            dataN : StoreInfo.Menu37_Grid11,
            dataAll : StoreInfo.Menu37_Grid12
        };
	    ...
	    this.sub_page0 = new Ext.Component({
		    ...
		    height: '100%',
		    flex:1,
		    html:'<iframe id="Menu37_iframe0" src="./extjs/sub_view/add_sales_sum.html" style="width:100%;height:100%" frameborder=0 scrolling="no" />'
        });
        
        //콜백함수 세팅  
        Menu37_Req_Callback0 = this.onRequestSumListButtonClick;
    	Ext.getCmp('Menu37_Sub_content0').add(this.sub_page0); 
    },
    ...
    onTabpanelTabChange: function(tabPanel, newCard, oldCard, eOpts) {
        ...
        if (newCard.itemId == 'type1') {
        	...
        	//하단 인쇄 타이틀 변경
        	Ext.getCmp('Menu37_print_btn').setText('매출처별 계산서 합계표 인쇄');
        }
        
        if (newCard.itemId == 'type2') {
        	thisObj.temp.type = 1;
        	thisObj.param.type1 = '52';
        	thisObj.param.type2 = '';
        	//thisObj.param.type1 = '51';
        	//thisObj.param.type2 = '54';
        	
        	//하단 인쇄 타이틀 변경
        	Ext.getCmp('Menu37_print_btn').setText('매입처별 계산서 합계표 인쇄');
        }
        ...
        if (!newCard.isCall) {
    	    ...
    	    this.sub_page1 = new Ext.Component({
    		    ...
    		    height: '100%',
    		    flex:1,
    		    html:'<iframe id="Menu37_iframe1" src="./extjs/sub_view/add_income_sum.html" style="width:100%;height:100%" frameborder=0 scrolling="no" />'
            });
    	    Ext.getCmp('Menu37_Sub_content1').add(this.sub_page1); 
    	    
    	    Menu37_Req_Callback1 = this.onRequestSumListButtonClick;
    ...
    onRequestSumListButtonClick: function(button, e, eOpts) {
        ...
        thisObj.param.from_atax_yyyymm = Ext.getCmp('Menu37_From_Year').getValue() + Ext.String.leftPad(Ext.getCmp('Menu37_From_Month').getValue(), 2, '0');
        thisObj.param.to_atax_yyyymm = Ext.getCmp('Menu37_From_Year').getValue() + Ext.String.leftPad(Ext.getCmp('Menu37_To_Month').getValue(), 2, '0');
    ...
    setData: function(data, type) {
        ...
        console.log('#Menu37_iframe'+type);
        
        var ifr = $('#Menu37_iframe'+type).contents();
    	var sum_cnt = 0;
    	var sum_price = 0;
    	var sum_tax = 0;
    	var sum_customer = 0;
		...
		//년
		info.yyyy = Ext.getCmp('Menu37_To_Year').getValue();
		
		//기
		if(Number(Ext.getCmp('Menu37_To_Month').getValue())<7) info.gi = 1;
		else info.gi = 2;
		...
		//거래기간 
		info.s_from_yyyy =  Ext.getCmp('Menu37_To_Year').getValue();
		info.s_from_mm = Ext.String.leftPad(Ext.getCmp('Menu37_From_Month').getValue(), 2, '0');
		info.s_from_dd = '01';
		
		info.s_to_yyyy =  Ext.getCmp('Menu37_To_Year').getValue();
		info.s_to_mm = Ext.String.leftPad(Ext.getCmp('Menu37_To_Month').getValue(), 2, '0');
		if(Ext.getCmp('Menu37_To_Month').getValue() == '6' || Ext.getCmp('Menu37_To_Month').getValue() == '9') info.s_to_dd = '30';
    ...
    generateSalesSumPrintData: function() {
    	...
    	var ret = {};
    	var page1 = {}, page2 = {};
    	var ifr = $('#Menu37_iframe0').contents();
    	...
    	//년도
    	page1.title.yyyy = Ext.getCmp('Menu37_From_Year').getValue();
    	//기수
    	page1.title.gi = 1;
    	if(Ext.getCmp('Menu37_To_Month').getValue() == 9 ||Ext.getCmp('Menu37_To_Month').getValue() == 12) page1.title.gi = 2;
		...
		page1.top_info.from_yyyy =  Ext.getCmp('Menu37_From_Year').getValue();
		page1.top_info.to_yyyy =  Ext.getCmp('Menu37_From_Year').getValue();
		
		var tmp0 = Ext.getCmp('Menu37_From_Month').getValue();
		var tmp1 = Ext.getCmp('Menu37_To_Month').getValue();
		...
		for(var i=1; i<=4; i++)
		{
			...
			/*
			page1.sum_data['sum'+i] = 5;
			page1.sum_data['val1_'+i] = 6;
			page1.sum_data['val2_'+i] = 7;
			page1.sum_data['val3_'+i] = 8
			page1.sum_data['val4_'+i] = 9;
			page1.sum_data['val5_'+i] = 10;
			page1.sum_data['val6_'+i] = 11;
			*/
		}
		...
		if(page2.tmp_list &&page2.tmp_list.length>5)
		{
			//(을)서식 붙임 + 매수
			//년도
			page2.yyyy = Ext.getCmp('Menu37_From_Year').getValue();
	    	//기수
			page2.gi = 1;
	    	if(Ext.getCmp('Menu37_To_Month').getValue() == 9 ||Ext.getCmp('Menu37_To_Month').getValue() == 12) page1.title.gi = 2;
    ...
    generatePurchaseSumPrintData: function() {
    	...
    	var ret = {};
    	var page1 = {}, page2 = {};
    	var ifr = $('#Menu37_iframe1').contents();
