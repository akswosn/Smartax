				                        ...
				                        },
				                        {
				                            ...
				                            editor: new Ext.create('Ext.form.ComboBox', {
											    ...
											    listeners: {
											    	keydown: {
						                                fn: function(field, e, options) {
						                                	console.log('keydown '+e.getKey());
						                                    if(e.getKey()==113){
						                                    	console.log('113-->'+gycode_Skey);
											    	...
											    	keydown: {
						                                fn: function(field, e, options) {
						                                    if(e.getKey()==113){
						                                    	...
						                                    	pop.grid = grid;
						                                    	pop.record = grid.getSelectionModel().getSelection()[0];
						                                    	console.log(customer_StrKey);
						                                    	console.log(customer_SKey);
											...
											items: [
								               	...
								               	},
												{
								               	...
								               	},
								               	{
								               		...
								               		width: 450,
								               		fieldCls: 'toolbar_field_help',
								               		value:'거래처코드를 입력하십시오. 모르면 F2키를 눌러 보조화면에서 선택하십시오.',
								               		cls:'bottomChild',
								               		readOnly : true
								               	},
								               	{
...
//***************************************  컨트롤러 ***************************************//
	...
	onMenu01_SearchKbn: function()
	{
		...
		if(this.curTab.itemId == 'grid2') this.onMenu01_Grid2BtnClick();
		else this.onMenu01_SearchBtnClick();
		this.curTab.isCall = true;
	},
   ...
   //저장 로직
    ...
    onMenu01_DescriptBtnClick: function(button, e, eOpts) {
		Global.openPopup(Ext.create('Common_Pop_Help'), '도움말(분개장 입력)', 'Menu01');
    }
