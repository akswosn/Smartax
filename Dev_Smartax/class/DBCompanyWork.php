...
class DBCompanyWork extends DBWork
{
	...
	/**
	 * 회사 정보 조회 - 현재 선택된 회사 정보 조회 (서비스 사용중)
	 * @return uid
	 * @throws Exception
	 */
...
// 				FROM `company_info` WHERE co_id = $co_id;";
		...
		$sql = "SELECT `i`.`co_id`, `co_nm`, `co_ceo_nm`
					  , `co_saup_no`, `co_co_no`, `co_up`
					  , `co_up_code`, `co_jong`, `co_zip`
					  , `co_addr`, `co_tel`, `co_tel_juso`
					  , `co_handphone`, `co_email`, `co_tax_office`
					  , `co_tax_office_code`, `co_tax_office_acc`
					  , `co_bank`, `co_bank_branch`, `co_bank_acc`, `co_fax`
					  , `co_config`, `hometax_id`,  `hometax_pwd`
					  , `tax_type`, `co_tax_type`, `co_joint`, `co_lease`
					  , `co_area`, `co_building_upstairs`, `co_building_downstairs`
					  , `co_building_t_area`, `co_building_area`, `co_room_cnt`
					  , `co_table_cnt`, `co_is_parking_area`, `co_vehicle_car`
					  , `co_vehicle_truck`, `co_vehicle_business`
					  , `co_employee_cnt`, `co_chair_cnt`
					  , `co_etc_bigo`, `co_expense_deposit`
					  , `co_expense_m_rent`, `co_expense_elect`
					  , `co_expense_water`, `co_expense_man`, `co_expense_etc`
					FROM `smartax`.`company_info` `i`, `smartax`.`company_info_detail` `d`
					where i.co_id = d.co_id and i.co_id=$co_id;";
...
// 		$co_id = $this->param['co_id'];
	...
	public function requestComInfo()
	{
		...
		$sql = "SELECT  `co_nm`, `co_ceo_nm`, `co_saup_no`, `co_co_no`, `co_up`, `co_up_code`, `co_jong`, `co_zip`,
				    `co_addr`,  `co_tel`, `co_tel_juso`,  `co_handphone`,  `co_email`,  `co_fax`,  `co_tax_office`,
				    `co_tax_office_code`, `co_tax_office_acc`, `co_bank`, `co_bank_branch`, `co_bank_acc`
				FROM `smartax`.`company_info` WHERE co_id = $co_id;";
		$this->querySql($sql);
