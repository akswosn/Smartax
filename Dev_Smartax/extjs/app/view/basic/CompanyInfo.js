 ...
 * 
 */
Ext.define('Smartax.view.basic.CompanyInfo', {
						 ...
						 items:[
							 {
								 ...
								 id:'co_expense_deposit',
								 flex : 4,
								 listeners : {
									 change:  {
				                            fn: function(field, e, options) {
				                            	var total = 0;
				                            	total = Number(Ext.getCmp('co_expense_deposit').value)
	                            					+ Number(Ext.getCmp('co_expense_m_rent').value)
	                            					+ Number(Ext.getCmp('co_expense_elect').value)
	                            					+ Number(Ext.getCmp('co_expense_water').value)
	                            					+ Number(Ext.getCmp('co_expense_man').value)
	                            					+ Number(Ext.getCmp('co_expense_etc').value);
				                            	Ext.getCmp('total_cost').setValue(total);
				                            }
				                       	},
								 }
							 },
